...
describe('SEC', function() {
  ...
  before(function(){
    ...
    var responses = {
      '3709785cec06a4d24afb6042ab8592e3': read('html/filing/1437519/9999999997-08-028074-index.htm')
    };
  ...
  describe('BrowseEdgar', function() {
    describe('Creative', function() { 
      it('parse Form 4 0001437519/999999997-08-028074', function(done) {
        var filing = new BrowseEdgar.filing({});
        filing.query({
          cik: '0001437519', 
          accession: '999999997-08-028074'
        }, function(err, result) {
          // console.log('0001127602-18-001998', result);
          assert.equal(result.info.filing_date, '2008-06-10');
