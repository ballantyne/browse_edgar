...
describe('SEC', function() {
  ...
  before(function(){
    ...
    var responses = {
      '4ff473f3ed9ef47497c0309574059ad4': read('html/filing/1288776/0001193125-16-520367-index.htm')
    };
  ...
  describe('BrowseEdgar', function() {
    describe('Google', function() { 
      it('parse Form 10-K/A 0001288776/0001193125-16-520367', function(done) {
        var filing = new BrowseEdgar.filing({});
        filing.query({
          cik: '0001288776', 
          accession: '0001193125-16-520367'
        }, function(err, result) {
          // console.log('0001193125-16-520367', result);
          assert.equal(result.info.filing_date, '2016-03-29');
