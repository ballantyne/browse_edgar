...
describe('SEC', function() {
  ...
  before(function(){
    ...
    var responses = {
      'ce7134b8d2da838d74e49aadea85fe0a': read('html/filing/51143/0001104659-18-018788-index.htm')
    };
  ...
  describe('BrowseEdgar', function() {
    describe('IBM', function() { 
      it('parse Form 8-K 0000051143/0001104659-18-018788', function(done) {
        var filing = new BrowseEdgar.filing({});
        filing.query({
          cik: '0000051143', 
          accession: '0001104659-18-018788'
        }, function(err, result) {
          // console.log('0001104659-18-018788', result);
          assert.equal(result.info.filing_date, '2018-03-20');
