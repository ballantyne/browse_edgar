...
describe('SEC', function() {
  ...
  before(function(){
    ...
    var responses = {
      '30dc173d02aeeeb05746484c6a208451': read('html/filing/1577552/0001104659-18-011926-index.htm')
    };
  ...
  describe('BrowseEdgar', function() {
    describe('Taobao', function() { 
      it('parse Form 6-K 0001577552/0001104659-18-011926', function(done) {
        var filing = new BrowseEdgar.filing({});
        filing.query({
          cik: '0001577552', 
          accession: '0001104659-18-011926'
        }, function(err, result) {
          // console.log('0001104659-18-011926', result);
          assert.equal(result.info.filing_date, '2018-02-26');
