...
describe('SEC', function() {
  ...
  before(function(){
    ...
    var responses = {
      'a04b880232705705de16c8eef1015d2a': read('html/filing/67182/0000950103-00-000186-index.htm')
    };
  ...
  describe('BrowseEdgar', function() {
    describe('Mobil', function() { 
      it('parse Form POS AM 0000067182/0000950103-00-000186', function(done) {
        var filing = new BrowseEdgar.filing({});
        filing.query({
          cik: '0000067182', 
          accession: '0000950103-00-000186'
        }, function(err, result) {
          // console.log('0000950103-00-000186', result);
          assert.equal(result.info.filing_date, '2000-02-09');
