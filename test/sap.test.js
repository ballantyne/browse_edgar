...
describe('SEC', function() {
  ...
  before(function(){
    ...
    var responses = {
      'b4f280b25893108c3a5bcbe5a4e08a78': read('html/filing/1064774/9999999997-03-016298-index.htm')
    };
  ...
  describe('BrowseEdgar', function() {
    describe('SAP', function() { 
      it('parse Form 6-K 0001064774/9999999997-03-016298', function(done) {
        var filing = new BrowseEdgar.filing({});
        filing.query({
          cik: '0001064774', 
          accession: '9999999997-03-016298'
        }, function(err, result) {
          // console.log('9999999997-03-016298', result);
          assert.equal(result.info.filing_date, '2003-04-07');
