...
describe('SEC', function() {
  ...
  before(function(){
    ...
    var responses = {
      'b963059afcaca090926c51a6ad3ad34c': read('html/filing/1081316/0001081316-18-000017-index.htm')
    };
  ...
  describe('BrowseEdgar', function() {
    describe('Mid-American Energy', function() { 
      it('parse Form 8-K 0001081316/0001081316-18-000017', function(done) {
        var filing = new BrowseEdgar.filing({});
        filing.query({
          cik: '0001081316', 
          accession: '0001081316-18-000017'
        }, function(err, result) {
          // console.log('0001127602-18-001998', result);
          assert.equal(result.info.filing_date, '2018-03-27');
