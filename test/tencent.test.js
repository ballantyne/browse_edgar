...
describe('SEC', function() {
  ...
  before(function(){
    ...
    var responses = {
      '738c9e7958732cd5d5763287e96995a3': read('html/filing/1293451/0000950103-18-001851-index.htm')
    };
  ...
  describe('BrowseEdgar', function() {
    describe('Tencent', function() { 
      it('parse Form SC 13G/A 0001293451/0000950103-18-001851', function(done) {
        var filing = new BrowseEdgar.filing({});
        filing.query({
          cik: '0001293451', 
          accession: '0000950103-18-001851'
        }, function(err, result) {
          // console.log('0000950103-18-001851', result);
