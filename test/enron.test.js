...
describe('SEC', function() {
  ...
  before(function(){
    ...
    var responses = {
      "94eb96d06044a2c5aed43347ed75d6b5": read('html/filing/72859/0000914121-04-000661-index.htm'),
    };
  ...
  describe('BrowseEdgar', function() {
    describe('Enron', function() { 
      it('parse Form U-12-IB 0000072859/0000914121-04-000661', function(done) {
        var filing = new BrowseEdgar.filing({});
        filing.query({
          cik: '0000072859', 
          accession: '0000914121-04-000661'
        }, function(err, result) {
          // console.log('0001127602-18-001998', result);
          assert.equal(result.info.filing_date, '2004-04-09');
