...
describe('SEC', function() {
  ...
  before(function(){
    ...
    var responses = {
      '48448c291d22ae4076fe5dc7520f5358': read('html/filing/1446710/0001193805-17-003081-index.htm')
    };
  ...
  describe('BrowseEdgar', function() {
    describe('US Steel', function() { 
      it('parse Form F-6 POS 0001446710/0001193805-17-003081', function(done) {
        var filing = new BrowseEdgar.filing({});
        filing.query({
          cik: '0001446710', 
          accession: '0001193805-17-003081'
        }, function(err, result) {
          // console.log('0001193805-17-003081', result);
          assert.equal(result.info.filing_date, '2017-09-29');
