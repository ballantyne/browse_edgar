...
describe('SEC', function() {
  ...
  before(function(){
    ...
    var responses = {
      '1b643a153ebac04449138c81b3336a28': read('html/filing/1326801/0001127602-18-001998-index.htm')
    };
  ...
  describe('BrowseEdgar', function() {
    describe('Facebook', function() { 
      it('parse Form 4 0001326801/0001127602-18-001998', function(done) {
        var filing = new BrowseEdgar.filing({});
        filing.query({
          cik: '0001326801', 
          accession: '0001127602-18-001998'
        }, function(err, result) {
          // console.log('0001127602-18-001998', result);
          assert.equal(result.info.filing_date, '2018-01-17');
