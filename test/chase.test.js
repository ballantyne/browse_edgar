...
describe('SEC', function() {
  ...
  before(function(){
    ...
    var responses = {
      'e2aa595967054dbea8d35af41a11af0a': read('html/filing/1412238/0001144204-07-057617-index.htm')
    };
  ...
  describe('BrowseEdgar', function() {
    describe('Chase', function() { 
      it('parse 0001412238/0001144204-07-057617', function(done) {
        var filing = new BrowseEdgar.filing({});
        filing.query({
          cik: '0001412238', 
          accession: '0001144204-07-057617'
        }, function(err, result) {
          // console.log('0001127602-18-001998', result);
          assert.equal(result.info.filing_date, '2007-11-01');
