...
describe('SEC', function() {
  ...
  before(function(){
    ...
    var responses = {
      '944a27915958fb3cfad7e013a18344f5': read('html/filing/1309001/9999999997-08-034718-index.htm')
    };
  ...
  describe('BrowseEdgar', function() {
    describe('Citi', function() { 
      it('parse Form REGDEX 0001309001/9999999997-08-034718', function(done) {
        var filing = new BrowseEdgar.filing({});
        filing.query({
          cik: '0001309001', 
          accession: '9999999997-08-034718'
        }, function(err, result) {
          // console.log('0001127602-18-001998', result);
          assert.equal(result.info.filing_date, '2008-07-31');
