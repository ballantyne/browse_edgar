...
describe('SEC', function() {
  ...
  before(function(){
    ...
    var responses = {
      '3313720055988fc81c8936a922f3dd64': read('html/filing/37996/0000037996-18-000025-index.htm')
    };
  ...
  describe('BrowseEdgar', function() {
    describe('Ford', function() { 
      it('parse Form 10-K/A 0000037996/0000037996-18-000025', function(done) {
        var filing = new BrowseEdgar.filing({});
        filing.query({
          cik: '0000037996', 
          accession: '0000037996-18-000025'
        }, function(err, result) {
          // console.log('0000037996/0000037996-18-000025', result);
