...
describe('SEC', function() {
  ...
  before(function(){
    ...
    var responses = {
      '8c8784f8630dd63cdc8f60a89a7333d2': read('html/filing/352541/0000352541-18-000033-index.htm')
    };
  ...
  describe('BrowseEdgar', function() {
    describe('Alliant Energy', function() { 
      it('parse Form 8-K 0000352541/0000352541-18-000033', function(done) {
        var filing = new BrowseEdgar.filing({});
        filing.query({
          cik: '0000352541', 
          accession: '0000352541-18-000033'
        }, function(err, result) {
          // console.log('0000352541-18-000033', result);
          assert.equal(result.info.filing_date, '2018-03-15');
