...
describe('SEC', function() {
  ...
  before(function(){
    ...
    var responses = {
      '3a1fe8c3a1d73d13fde9682669a9804b': read('html/filing/1166387/0000876661-13-000149-index.htm')
    };
  ...
  describe('BrowseEdgar', function() {
    describe('Comcast', function() { 
      it('parse Form 25-NSE 0001166387/0000876661-13-000149', function(done) {
        var filing = new BrowseEdgar.filing({});
        filing.query({
          cik: '0001166387', 
          accession: '0000876661-13-000149'
        }, function(err, result) {
          // console.log('0001127602-18-001998', result);
          assert.equal(result.info.filing_date, '2013-03-26');
